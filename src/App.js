                ...
                <ul class="d-flex justify-content-end list-unstyled m-0">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span style={{ color: "#900" }}>{cartItems.length}</span>
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div class="row">
              <div class="col-lg-6 pt-5 mt-5">
                <h2 class="display-1 ls-1">
                  <span class="fw-bold text-primary">Organic</span> Foods at
                  your <span class="fw-bold">Doorsteps</span>
                </h2>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="card-body p-0">
                        ...
                        <p class="card-text">Organic food from factory</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="card-body p-0">
                        ...
                        <p class="card-text">Trust the Process i don't lie</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="card-body p-0">
                        ...
                        <p class="card-text">24 Province 100% off</p>
                      </div>
                    </div>
                  </div>
                </div>
